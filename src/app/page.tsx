...
function AnimatedStat({
  ...
  return (
    ...
    >
      <div className="p-3 rounded-2xl bg-white/10 backdrop-blur-sm group-hover:bg-white/20 group-hover:scale-110 transition-all duration-300 border border-white/10">
  ...
  const features = [
    {
      ...
      desc: t("features.smart_desc"),
      color: "from-primary to-primary-dark",
    },
    {
      icon: Target,
      title: t("features.quiz"),
      desc: t("features.quiz_desc"),
    ...
    {
      icon: Shield,
      title: t("features.trusted"),
      desc: t("features.trusted_desc"),
    ...
    <main className="flex-1 flex flex-col">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary-dark to-secondary">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24 relative">
            ...
            <div className="text-center lg:text-right stagger-children">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
                <Link href="/auth/register">
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-warning to-accent text-white hover:from-warning/90 hover:to-accent/90 shadow-2xl shadow-warning/30 flex items-center gap-2 px-8 hover:scale-105 transition-all duration-300"
                  >
                    {t("landing.hero.cta")}
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 mt-10">
                <div className="flex -space-x-2">
                  {["S", "M", "N", "A"].map((l, i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full border-2 border-white bg-primary/30 backdrop-blur-sm flex items-center justify-center text-white text-sm font-bold"
                    >
                      {l}
                    </div>
                  ))}
            ...
            <div className="hidden lg:flex items-center justify-center relative">
              {homeHero ? (
                <div className="relative w-full max-w-lg animate-float">
                  ...
                  <div className="absolute -bottom-4 -right-4 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-4 shadow-xl">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3 mt-6">
                        {[1, 2, 3, 4].map((i) => (
                          <div
                            key={i}
                            className="h-20 bg-white/10 rounded-xl border border-white/10 p-3"
                          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-16 pt-10 border-t border-white/10">
            <AnimatedStat
              icon={Video}
              label={t("landing.stat.video")}
              value={200}
              suffix={t("landing.stat.video_val")}
            />
            <AnimatedStat
              icon={BookOpen}
              label={t("landing.stat.quiz")}
              value={1000}
              suffix={t("landing.stat.quiz_val")}
            />
            <AnimatedStat
              icon={Users}
              label={t("landing.stat.students")}
              value={5000}
              suffix={t("landing.stat.students_val")}
            />
          </div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {steps.map((step, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="relative flex flex-col items-center text-center group slide-up"
                    style={{ animationDelay: `${i * 0.1}s` }}
                  >
                    <div className="relative mb-4">
                      <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center shadow-xl shadow-primary/20 group-hover:scale-110 group-hover:shadow-2xl transition-all duration-300">
                        <Icon className="w-7 h-7 text-white" />
                      </div>
                      <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-gradient-to-br from-primary to-secondary text-white text-xs font-bold flex items-center justify-center shadow-lg">
                        {i + 1}
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => {
              ...
              return (
                <div
                  key={i}
                  className="group relative bg-surface border border-border rounded-2xl p-6 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 transition-all duration-300 slide-up"
                  style={{ animationDelay: `${i * 0.05}s` }}
                >
                  <div
                    className={`p-3 rounded-xl bg-gradient-to-br ${f.color} w-fit mb-4 shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl`}
                  >
                    <Icon className="w-6 h-6 text-white" />
                  </div>
                  <h3 className="text-lg font-bold text-text-primary mb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative group slide-up" style={{ animationDelay: "0.2s" }}>
              {homeVideo ? (
                ...
                <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-primary/20 to-secondary/20 border border-border aspect-video flex items-center justify-center shadow-2xl">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-secondary/10" />
                  <div className="relative text-center">
                    <div className="w-20 h-20 mx-auto rounded-full bg-white/90 shadow-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 cursor-pointer">
                      <Play className="w-8 h-8 text-primary mr-0.5" />
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-br from-primary via-primary-dark to-secondary relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          >
            <path
              d="M0 200 C 300 0, 600 400, 900 200 S 1200 0, 1440 200"
              stroke="white"
              strokeWidth="2"
            />
            <path
              d="M0 300 C 300 100, 600 500, 900 300 S 1200 100, 1440 300"
              stroke="white"
              strokeWidth="1"
              opacity="0.5"
            />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4 slide-up">
            {t("cta.title")}
          </h2>
          <p className="text-white/80 max-w-xl mx-auto mb-8 text-lg slide-up" style={{ animationDelay: "0.1s" }}>
            {t("cta.desc")}
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4 slide-up" style={{ animationDelay: "0.2s" }}>
            <Link href="/auth/register">
              <Button
                size="lg"
                className="bg-gradient-to-r from-warning to-accent text-white hover:from-warning/90 hover:to-accent/90 shadow-2xl shadow-warning/30 flex items-center gap-2 hover:scale-105 transition-all duration-300"
              >
                {t("cta.button")}
                <ArrowLeft className={`w-5 h-5 ${isRTL ? "" : "rotate-180"}`} />
              </Button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="slide-up" style={{ animationDelay: "0.05s" }}>
              ...
              <div className="space-y-2 text-sm text-text-secondary">
                <Link href="/colleges" className="block hover:text-primary transition-colors">
                  {t("nav.colleges")}
                </Link>
                ...
                <Link href="/auth/register" className="block hover:text-primary transition-colors">
                  {t("nav.register")}
                </Link>
                <Link href="/auth/login" className="block hover:text-primary transition-colors">
                  {t("nav.login")}
                </Link>
              </div>
            </div>
